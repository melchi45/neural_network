...
//****************************************************************************
//##ModelId=3A1160D303B5
void SON_Node::Print(std::ofstream &out)
{
...
//##ModelId=3A1160D50155
void SON_Network::Print(std::ofstream &out)
{
...
//##ModelId=3A1160D50104
void SON_Network::Save(std::ofstream &outfile)
{
	outfile << id << std::endl;

	outfile << init_learning_rate << std::endl;
	outfile << final_learning_rate << std::endl;
	outfile << init_neigh_size << std::endl;
	outfile << neigh_decrement_interval << std::endl;
	outfile << num_iterations << std::endl;
	outfile << x_size << std::endl;
	outfile << y_size << std::endl;
...
//##ModelId=3A1160D50118
void SON_Network::Load(std::ifstream &infile)
{
	infile >> id;
